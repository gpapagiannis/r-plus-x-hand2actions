...
task_folder = "assets/grasp_fanta" # folder with the task, also do "assets/pick_up_phone" for pick up phone. if you change task uncomment the corresponding intrinsics matrix below.
...
INTRINSICS_REAL_CAMERA = np.load("assets/utils/intrinsics_rgb_d455.npy") # intrinsics for camera used for grasp_fanta
# INTRINSICS_REAL_CAMERA = np.load("assets/utils/head_cam_intrinsic_matrix_aligned_depth.npy") # intrinsics for camera used for pick_up_phone
